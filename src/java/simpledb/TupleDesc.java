...
public class TupleDesc implements Serializable {
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
    	...
    	td.size=td1.getSize()+td2.getSize();
    	for (TDItem item1:td1.Items) {
    		td.Items.add(item1);
    	}
    	for (TDItem item2:td2.Items) {
    		td.Items.add(item2);
    	}
        return td;
    }
    ...
    public boolean equals(Object o) {
    	...
    	if (size!=td.size) return false;
    	if (Items.size()!=td.Items.size()) return false;
    	for (int i=0;i<Items.size();++i) {
    		if (Items.get(i).fieldType!=td.Items.get(i).fieldType) return false;
    	}
    	return true;
    }
    ...
    public String toString() {
    	String ans="";
    	for (int i=0;i<Items.size();++i) {
    		ans=ans+Items.get(i).toString();
    		if (i!=Items.size()-1) ans+=",";
    	}
        // some code goes here
        return ans;
    }
